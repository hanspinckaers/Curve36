...
.extrude({ offset: [0, 0, 1] });
                ...
                function pdb_case_fn() {
                    

                // creating part 0 of case pdb
                let pdb__part_0 = board_extrude_1_outline_fn();

                // make sure that rotations are relative
                let pdb__part_0_bounds = pdb__part_0.getBounds();
                let pdb__part_0_x = pdb__part_0_bounds[0].x + (pdb__part_0_bounds[1].x - pdb__part_0_bounds[0].x) / 2
                let pdb__part_0_y = pdb__part_0_bounds[0].y + (pdb__part_0_bounds[1].y - pdb__part_0_bounds[0].y) / 2
                pdb__part_0 = translate([-pdb__part_0_x, -pdb__part_0_y, 0], pdb__part_0);
                pdb__part_0 = rotate([0,0,0], pdb__part_0);
                pdb__part_0 = translate([pdb__part_0_x, pdb__part_0_y, 0], pdb__part_0);

                pdb__part_0 = translate([0,0,0], pdb__part_0);
                let result = pdb__part_0;

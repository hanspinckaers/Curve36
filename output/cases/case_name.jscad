...
.extrude({ offset: [0, 0, 1] });
                ...
                function case_name_case_fn() {
                    

                // creating part 0 of case case_name
                let case_name__part_0 = board_extrude_1_outline_fn();

                // make sure that rotations are relative
                let case_name__part_0_bounds = case_name__part_0.getBounds();
                let case_name__part_0_x = case_name__part_0_bounds[0].x + (case_name__part_0_bounds[1].x - case_name__part_0_bounds[0].x) / 2
                let case_name__part_0_y = case_name__part_0_bounds[0].y + (case_name__part_0_bounds[1].y - case_name__part_0_bounds[0].y) / 2
                case_name__part_0 = translate([-case_name__part_0_x, -case_name__part_0_y, 0], case_name__part_0);
                case_name__part_0 = rotate([0,0,0], case_name__part_0);
                case_name__part_0 = translate([case_name__part_0_x, case_name__part_0_y, 0], case_name__part_0);

                case_name__part_0 = translate([0,0,0], case_name__part_0);
                let result = case_name__part_0;
